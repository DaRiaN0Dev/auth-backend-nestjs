...
-- CreateEnum
CREATE TYPE "public"."UserStatus" AS ENUM ('ACTIVE', 'PENDING_VERIFICATION', 'LOCKED', 'SUSPENDED');
...
-- CreateIndex
CREATE INDEX "TwoFactorSecret_enabled_idx" ON "public"."TwoFactorSecret"("enabled");
